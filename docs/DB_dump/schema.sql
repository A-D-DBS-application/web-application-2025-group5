...
\restrict 36L2FQULA5KEW2nPabrojD7rQXj3r2ntY1FkqGEHFGrKGc74Q2JhjWQcM8GcolE
...
CREATE TABLE public.groups (
    ...
    app_fee numeric(10,2) DEFAULT 0.00,
    icon text
);
...
CREATE FUNCTION public.get_user_groups(uid integer) RETURNS SETOF public.groups
    LANGUAGE sql STABLE
    AS $$
  select g.*
...
ALTER FUNCTION public.get_user_groups(uid integer) OWNER TO postgres;
...
--
-- Name: expense_items_item_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.expense_items_item_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.expense_items_item_id_seq OWNER TO postgres;

--
-- Name: expense_items_item_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.expense_items_item_id_seq OWNED BY public.expense_items.item_id;
...
CREATE TABLE public.expense_shares (
    ...
    CONSTRAINT expense_shares_amount_check CHECK ((amount >= (0)::numeric))
);
...
--
-- Name: expense_items item_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.expense_items ALTER COLUMN item_id SET DEFAULT nextval('public.expense_items_item_id_seq'::regclass);
...
--
-- Name: expense_shares expense_shares_expense_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.expense_shares
    ADD CONSTRAINT expense_shares_expense_id_fkey FOREIGN KEY (expense_id) REFERENCES public.expenses(expense_id) ON DELETE CASCADE;


--
-- Name: expense_shares expense_shares_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.expenses
    ADD CONSTRAINT expenses_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(group_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.expenses
    ADD CONSTRAINT expenses_paid_by_fkey FOREIGN KEY (paid_by) REFERENCES public.users(user_id);
...
--
-- Name: groups groups_organizer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.groups
    ADD CONSTRAINT groups_organizer_id_fkey FOREIGN KEY (organizer_id) REFERENCES public.users(user_id);
...
ALTER TABLE ONLY public.payments
    ADD CONSTRAINT payments_from_user_fkey FOREIGN KEY (from_user) REFERENCES public.users(user_id);
...
ALTER TABLE ONLY public.payments
    ADD CONSTRAINT payments_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(group_id);
...
ALTER TABLE ONLY public.payments
    ADD CONSTRAINT payments_to_user_fkey FOREIGN KEY (to_user) REFERENCES public.users(user_id);
...
--
-- Name: expense_items DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.expense_items USING (true) WITH CHECK (true);


--
-- Name: expense_shares DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.expense_shares USING (true) WITH CHECK (true);


--
-- Name: expenses DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.expenses USING (true) WITH CHECK (true);


--
-- Name: group_members DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.group_members USING (true) WITH CHECK (true);


--
-- Name: groups DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.groups USING (true) WITH CHECK (true);


--
-- Name: payments DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.payments USING (true) WITH CHECK (true);


--
-- Name: users DEV Allow all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "DEV Allow all" ON public.users USING (true) WITH CHECK (true);
...
--
-- Name: expense_shares; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_user_groups(uid integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_user_groups(uid integer) TO anon;
GRANT ALL ON FUNCTION public.get_user_groups(uid integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_user_groups(uid integer) TO service_role;
...
--
-- Name: SEQUENCE expense_items_item_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.expense_items_item_id_seq TO anon;
GRANT ALL ON SEQUENCE public.expense_items_item_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.expense_items_item_id_seq TO service_role;


--
-- Name: TABLE expense_shares; Type: ACL; Schema: public; Owner: postgres
--
...
\unrestrict 36L2FQULA5KEW2nPabrojD7rQXj3r2ntY1FkqGEHFGrKGc74Q2JhjWQcM8GcolE
